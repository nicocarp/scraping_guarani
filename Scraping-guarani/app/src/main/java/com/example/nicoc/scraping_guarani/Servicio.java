...
public class Servicio extends Service {
    ...
    final class MyThreadClass implements Runnable
    {
        ...
        private void crearNotificacion(){
            ...
            Intent intent = new Intent(Servicio.this, PrincipalActivity.class);
        ...
        * */
        private void sendBroadcast()
        {
            ...
            Intent resultIntent = new Intent("PrincipalActivity");//le pongo un nombre al intent asi se como atraparlo despues.
